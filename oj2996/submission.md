...
```text
Input:
รับค่าตัวอักษรภาษาอังกฤษเป็น str

Output:
แสดงผลกลับด้านตัวอักษรแบบพิมเล็กเท่านั้น

Constraints:
input บางตัวเป็นพิมใหญ่ควนแปลงให้เป็นพิมเล็กก่อนกลับด้านคำ
```
...
```text
Step 1:รับค่าตัวอักษรภาษาอังกฤษแล้วปรับให้เป็นตัวเล็กทั้งหมด
Step 2:ใช้วิธีการ slice string โดยตั้งให้  step = -1 แปลว่าอ่านจากตัวหลังมาตัวหน้า
Step 3:แสดงผลตัวอักษรที่ถูกกลับด้านแล้วอออกมา
```
...
```text
ใช้แผนแลกคือการสั่งให้มันนับจากตัวท้านถอยหลังมา
```
...
```text
ทดสอบว่าจะเกิด runtime errorมั้ยเนื่องจากเป็นขอบเขตขั้นต่ำ
```
...
```text
ทดสอบว่าจะแปลงเป็นพิมเล็กทั้งหมดหรือไม่
```
...
```text
ทดสอบว่าข้อความจะถูกสลับจากหลังมาหน้าแบบช่องว่างอยู่ตำแหน่งตรงข้ามพอดีหรือไม่
```
