...
Output:
แสดงเงินที่ต้องจ่ายหลังรวมกับค่าบริการกับVATแล้วเรียบร้อย
...
Step 2:หาค่า service charge จากค่าอาหาร
Step 3:เช็ค service charge น้อยกว่า 50 บาทหรือไม่ ถ้าใช้ให้ตั้งเป็นราคาขั้นต่ำ หรือ ถ้ามากกว่า 1000 ให้คิดเป็นราคาสูงสุดคือ 1000 บาท ถ้าไม่ตรงกับเงื่อนไขเลย ให้ใช้ค่าที่คำนวนได้เลย
Step 4:จากนั้นคำนวนsk Vat 7% แล้วรวมกับ ค่าที่ต้องจ่าย
Step 5: แสดงผลจำนวนทั้งหมดที่ต้องจ่าย
```
...
```text
ใช้แผนแรกโดยหาค่า service charge แล้วเช็คว่าเกินราคาขั้นสูงหรือต่ำกว่าราคาขั้นต่ำมั้ยถ้าใช่ให้ทำตามนั้น แต่ถ้าไม่ตรงให้ใช้ค่าที่คิดได้รวมกัน แล้วไปบวกกับ vat7%จากเงินที่รวม service charge แล้ว และเอาไปรวมกันก่อนแสดงผลโดยทศนิยม2ตำแหน่ง
```
...
```text
พิจารณาจากคำสั่งโดยถ้า service_charge <= 50.00 เป็นจริง ต้องบวกค่า service charge เป็นราคาขั้นต่ำ
```
...
```text
พิจารณาจากคำสั่งโดยถ้า service_charge <= 50.00 เป็นจริง ต้องบวกค่า service charge ในราคาขั้นต่ำซึ่งเท่ากับค่าservice chargeที่คำนวนได้
```
...
```text
พิจารณาจากคำสั่งโดยถ้า service_charge >= 1000.00 เป็นจริง ต้องบวกค่า service charge ในราคาขั้นสูงสุดซึ่งเท่ากับค่าservice chargeที่คำนวนได้
```
