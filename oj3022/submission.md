...
```text
input:
บรรทัดแรกรับค่าอุณหภูมิเป็นจำนวนจริง
บรรทัดสองรับค่าหน่วยของอุณหภูมิของบรรทัดแรก
บรรทัดสามรับค่าหน่วยที่ต้องการแปลง

output:
อุณหภูมิหน่วยของบรรทัดที่3ต้องการ โดยตอบเป็นจำนวนจริงทศนิยม2ตำแหน่ง

constraints:
สูตรคำนวณที่โจทย์ให้มาเป็นสูตรที่ใช้หน่วย celcius คำนวณเป็นหลัก
```
...
```text
Step 1:รับค่า อุณหภูมิ หน่วยที่รับมา และหน่วยที่ต้องการแปลง
Step 2:แปลงค่าอุณหภูมิให้เป็นหน่วย celcius ก่อนเพื่อให้ง่ายต่อการคำนวณ
Step 3:แปลงค่าอุณหภูมิที่เป็น celcius 0 จากขั้นตอนก่อนหน้านี้ให้เป็นหน่วยที่ต้องการแปลง และแสดงผลออกมาทศนิยม2ตำแหน่ง
```
...
```text
ใช้วิธีเดียวกับแผนแรกรับค่าอุณหภูมิ หน่วยที่รับเข้า ปละหน่วยที่ต้องการแปลง แปลงอุณหภูมิที่รับเข้าเป็น celcius และแปลงเป็นหน่วยที่ต้องการหลังจากแปลงหน่วยก่อนหน้านี้ และแสดงผลทศนิยม2ตำแหน่ง
```
...
```text
เนื่องจากหน่วยที่รับกับหน่วยที่ต้องการแปลงเป็นหน่วยเดียวกันเป็นการเช็คว่าค่าที่ได้จะเท่ากับที่รับหรือไม่
```
...
```text
เนื่องจาก 31 f แปลงเป็น c จะได้ 0 เมื่อแปลงค่าเป็น R จะคำนวนออกมาถูกหรือไม่
```
...
```text
เป็นการเช็คการทำงานของ else ว่าทำงานตรงตามที่สั่งหรือไม่ก่อนนำไปคำนวนต่อ
```
