...
```text
input:
บรรทัดแรกรับค่าคะแนนรวมของทั้งสามคน
บรรทัดสองรับค่าคะแนนสูงสุดในสามคนนี้

output:
แสดงผล "Surprising" หรือ "Not surprising"  โดยหาจากถ้าคะแนนต่ำสุดห่างจากคะแนนสูงสุดเกิน 2 คะแนนให้แสดงผล "Surprising" ถ้าไม่ "Not surprising"

constraints:
การคำนวนค่อนข้างยากเนื่องจากต้องหาค่าต่ำสุดจากค่าที่มีให้ทำให้จะได้เป็นค่าประมาณเท่านั้น
```
...
```text
Step 1:รับค่าคะแนนรวมกับคะแนนสูงสุด
Step 2:คำนวนหาคะแนนรวมของสองคนที่เหลือโดย นำคะแนนรวมลบกับคะแนนสูงสุด
Step 3:หาค่ากลางของคะแนนโดยเอาคะแนนรวมของสองคนที่เหลือหารด้วย 2
Step 4:ให้เช็คว่าค่ากลางคะแนนของสองคนที่เหลือมากกว่า คะแนนสูงสุดหรือไม่ ถ้าเกินให้ปรับให้เท่าคะแนนสูงสุด
Step 5:หาคะแนนต่ำสุดที่เป็นไปได้จากการนำคะแนนรวมของสองคนที่เหลือลบกับคะแนนสูงสุด
Step 6:เช็กว่าคะแนนต่ำสุดติดลบหรือไม่ถ้าใช่ให้ตั้งให้เป็น 0
Step 7:คำนวนหาความต่างจาก คะแนนสูงสุดลบด้วยคะแนนต่ำสุดที่เป็นไปได้ นั้นมากกว่า 2 หรือไม่
             Step 7.1:ถ้าจริงแสดงผล"Surprising"
             Step 7.2:ถ้าไม่แสดงผล"Not surprising"
```
...
```text
รับค่าคแนนรวมทั้ง3คนและคะแนนสูงสุด จากนั้นหาคะแนนรวมสองคนที่เหลือ หาค่ากลางที่เป็นไปได้ หาคะแนนต่ำสุดได้เท่าไหร่ แล้วเช็คว่าคะแนนต่ำสุดและสูงสุดลบกันแล้วได้ มากกว่า 2 หรือไม่
```
...
```text
ถ้าทุกคนได้คะแนนสูงสุดเท่ากันหมด
```
