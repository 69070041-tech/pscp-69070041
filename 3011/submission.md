...
```text
ผมได้ลองทำดูแล้วพบกับปัญหาที่ว่า บางครั้งแทนที่มันจะโชว์ค่าสีที่ได้จากการไปเทียบที่ผสมไว้มันดันไปแสดงผลสีเดียวกันกับ input อันแรก 
ซึ่งเดิมที statement นี้ควรแสดงหลังจากเทียบว่าเป็นสีเดียวกันจากทั้งสอง input ผมจึงได้ลองคิดวิธ๊ต่าง 
โดยสุดท้ายวิธีที่ผมใช้คือ ถ้า input1 = input2 ให้เทียบต่อจากเดิม ว่ามันอยู่ใน scope ของแม่สีหลักหรือไม่ ถ้าไม่ จะแสดงผล Error ทันที 
ถ้าใช่ แสดงผลค่าของ input อันแรกออกมา
```
