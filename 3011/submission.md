...
```text
โจทย์อธิบายว่า ชุดคำสั่งนี้ใช้สำหรับการผสมสีจากแม่สีหลัก โดยในนั้นมีสีแดง สีเหลือง และสีน้ำเงิน

โจทย์ระบุว่า ถ้าเอาสีแดงมาผสมกับสีเหลือง จะได้สีส้ม
          ถ้าเอาสีแดงมาผสมกับสีน้ำเงิน จะได้สีม่วง
          ถ้าเอาสีเหลืองมาผสมกับสีน้ำเงิน จะได้สีเขียว
          ถ้าเป็นสีอื่นๆนอกจาก 3 สีนี้ให้แสดงผลว่า Error
          
โจทย์ให้วิธีการรับค่าคือ input บรรทัด 1 แทน สีแรกที่จะใช้ในการผสม
                  input บรรทัด 2 แทน สีที่สองที่จะใช้ผสมด้วย

                  output ให้แสดงผลเป็นสีที่ผสมออกมา ถ้านอกเหนือจากนี้ให้แสดงผล Error
```
...
```text
Step 1:ผมได้เริ่มทำการเขียนโครงหลักของโค้ด คือการรับค่าตาม input specific
Step 2:จากนั้นเริ่มสร้างระบบวิธีการเทียบโดยการใช้ if-else เทียบ input ที่เหมือนกัน ถ้าใช้ให้ตอบสีนั้นๆ
Step 3:แล้วให้แสดงผลค่าสีที่ได้หลังจากการเทียบ
```
...
```text
ผมได้ลองทำดูแล้วพบกับปัญหาที่ว่า บางครั้งแทนที่มันจะโชว์ค่าสีที่ได้จากการไปเทียบที่ผสมไว้มันดันไปแสดงผลสีเดียวกันกับ input อันแรก ซึ่งเดิมที statement นี้ควรแสดงหลังจากเทียบว่าเป็นสีเดียวกันจากทั้งสอง input ผมจึงได้ลองคิดวิธ๊ต่าง โดยสุดท้ายวิธีที่ผมใช้คือ ถ้า input1 = input2 ให้เทียบต่อจากเดิม ว่ามันอยู่ใน scope ของแม่สีหลักหรือไม่ ถ้าไม่ จะแสดงผล Error ทันที ถ้าใช่ แสดงผลค่าของ input อันแรกออกมา
```
...
```text
โจทย์ไม่ได้ระบุว่าสีเหมือนกันต้องแสดงผลว่าอะไร
```
...
```text
เป็นการทดสอบว่าถ้าในกรณีที่สีไม่ตรงจะสามารถแสดงผลตามที่ expected output
```
...
```text
ถ้าในกรณีที่ input ตัวอักษรแรกเป็นตัวพิมเล็ก output จะออกมาเป็นอย่างไร
```
